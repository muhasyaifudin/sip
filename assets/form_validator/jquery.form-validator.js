...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
     ...
     */
    LANG: {
      errorTitle: 'Form submit gagal!',
      requiredField: 'Field ini wajib diisi',
      requiredFields: 'Anda belum mengisi semua field yang wajib diisi',
      badTime: 'Waktu yang diinputkan salah',
      badEmail: 'Email yang diinputkan salah',
      badTelephone: 'Nomor Telepon yang diinputkan salah',
      badSecurityAnswer: 'Jawaban keamanan yang anda berikan salah',
      badDate: 'Tanggal yang diinputkan salah',
      lengthBadStart: 'The input value must be between ',
      lengthBadEnd: ' karakter',
      lengthTooLongStart: 'Data yang diinputkan lebih panjang dari ',
      lengthTooShortStart: 'Data yang diinputkan lebih pendek dari ',
      notConfirmed: 'Data yang diinputkan tidak terkonfirmasi',
      badDomain: 'Nama domain salah',
      badUrl: 'URL yang diinputkan salah',
      badCustomVal: 'Data yang diinputkan salah',
      andSpaces: ' dan spasi ',
      badInt: 'Angka yang diinputkan salah',
      badSecurityNumber: 'Nomor keamanan anda salah',
      badUKVatAnswer: 'Incorrect UK VAT Number',
      badUKNin: 'Incorrect UK NIN',
      badUKUtr: 'Incorrect UK UTR Number',
      badStrength: 'The password isn\'t strong enough',
      badNumberOfSelectedOptionsStart: 'Harus pilih sekurangnya ',
      badNumberOfSelectedOptionsEnd: ' jawaban',
      badAlphaNumeric: 'Data yang diinputkan hanya boleh berupa karakter apfabet ',
      badAlphaNumericExtra: ' dan ',
      wrongFileSize: 'The file you are trying to upload is too large (max %s)',
      wrongFileType: 'Only files of type %s is allowed',
      groupCheckedRangeStart: 'Tolong pilih antara ',
      groupCheckedTooFewStart: 'Tolong pilih paling sedikit ',
      groupCheckedTooManyStart: 'Tolong pilih paling banyak ',
